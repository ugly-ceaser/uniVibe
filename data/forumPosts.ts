...
export const forumPosts: ForumPost[] = [
  {
    ...
    description:
      'Looking for study tips and resources for the upcoming Introduction to Computer Science exam.',
    content:
  ...
  },
  {
    ...
    description:
      'New student looking for recommendations on where to get good and affordable meals.',
    content:
  ...
  },
  {
    ...
    author: 'Grace Okoro',
    description:
      'Looking to form a study group for Mathematics 101. Anyone interested?',
    content:
  ...
  },
  {
    ...
    author: 'Jennifer Ade',
    description:
      "Can't connect to the library WiFi. Does anyone know the current password?",
    content:
  ...
  },
  {
    ...
    author: 'Robert Kim',
    description:
      'Stuck on a Python assignment about loops and functions. Need some guidance.',
    content:
