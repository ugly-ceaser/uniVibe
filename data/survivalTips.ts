...
export const survivalTips: SurvivalTip[] = [
  ...
  },
  {
    ...
    category: 'Academics',
    content: 'Study groups can be incredibly effective when done right. Choose committed group members who share similar academic goals. Establish clear ground rules about meeting times, preparation expectations, and group dynamics.\n\nRotate leadership roles and teaching responsibilities. Explaining concepts to others reinforces your own understanding. Use study groups for problem-solving sessions, exam preparation, and project collaboration.',
    readTime: '4 min read',
  },
  ...
  // Budgeting
  {
    ...
    category: 'Budgeting',
    content: 'Creating and sticking to a budget is essential for financial stability during university. Track all your income sources (allowances, part-time jobs, scholarships) and categorize your expenses (tuition, accommodation, food, transportation, entertainment).\n\nUse budgeting apps or a simple spreadsheet to monitor your spending. Allocate 50% for needs, 30% for wants, and 20% for savings. Review and adjust your budget monthly based on your spending patterns.',
    readTime: '4 min read',
  },
  {
    id: '7',
    ...
    category: 'Budgeting',
    content: 'Your student ID is your ticket to numerous discounts! Many businesses offer student discounts on food, transportation, software, and entertainment. Always ask if a student discount is available before making purchases.\n\nLook for campus meal plans, group buying opportunities, and second-hand textbook markets. Consider sharing resources like textbooks and study materials with classmates to reduce costs.',
    readTime: '2 min read',
  },
  ...
  },
  {
    ...
    category: 'Safety',
    content: 'Use strong, unique passwords for all your accounts, especially university portals and email. Enable two-factor authentication wherever possible. Be cautious about sharing personal information on social media.\n\nUse the university\'s secure Wi-Fi networks and avoid public Wi-Fi for sensitive activities. Regularly backup your academic work to cloud storage or external drives to prevent data loss.',
    readTime: '3 min read',
  },
];
